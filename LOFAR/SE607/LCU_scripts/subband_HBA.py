...
for subband in xrange(0,num_subbands,1):
  freq_low = 100 + ((subband-0.5) * clock_freq / 2.0 / num_subbands)
  freq_mid = 100 + (subband * clock_freq / 2.0 / num_subbands)
  freq_high = 100 + ((subband+0.5) * clock_freq / 2.0 / num_subbands)
